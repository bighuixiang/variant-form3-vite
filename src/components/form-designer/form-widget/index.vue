<template>
  <div class="form-widget-container">
    ...
    <el-form class="full-height-width widget-form" :label-position="labelPosition" :inline="isWrap"
        ...
        <draggable :list="designer.widgetList" item-key="id"
          ...
          <template #item="{ element: widget, index }">
            <div class="transition-group-el"
                 :class="{ 'transition-group-el-inline': 'container' !== widget.category && isWrap }">
              <template v-if="'container' === widget.category">
                <component :is="getWidgetName(widget)" :widget="widget" :designer="designer" :key="widget.id"
                           ...
                           :class="{ 'transition-group-component-inline': isWrap }">
                </component>
              </template>
              <template v-else>
...
export default {
  ...
  computed: {
    ...
    isWrap() {
      return this.designer.formConfig.isWrap
    },
  },
  watch: {
    'designer.widgetList': {
...
.form-widget-container {
  :deep(.el-form--inline) {
    .transition-group-el-inline {
      display: inline-block;
    }
  }

  .transition-group-component-inline {
    :deep(.form-widget-list) {
      display: inline-block;
    }
  }
}
