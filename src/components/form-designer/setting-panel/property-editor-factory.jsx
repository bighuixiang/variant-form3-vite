...
export const createEditCodeButtonEditor = function (
  eventPropName,
  labelName = "编辑代码",
  btnName = "编辑代码"
) {
  return {
    ...
    mixins: [emitter],
    methods: {
      editEditCodeButtonHandler() {
        this.dispatch("SettingPanel", "editEditCodeButtonHandler", [
          eventPropName,
          btnName,
        ]);
      },
    ...
    render(h) {
      return (
        <el-form-item label={labelName} label-width="150px">
          <el-button
            type="primary"
            icon="el-icon-edit"
            plain
            round
            onClick={this.editEditCodeButtonHandler}
          >
            {btnName}
          </el-button>
        </el-form-item>
